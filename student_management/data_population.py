...
def populate_db():
    admins = [
        ...
        'rc_number':'987654321',
        'school_mail':'altschoolafrica@gmail.com',
        'is_superadmin': True,
    ...
    courses = [
        {'course_code':'BEE101','credit_hours': 3,'name':'Back End Engineering'},
        {'course_code':'FEE102','credit_hours': 1,'name':'Front End Engineering'},
        {'course_code':'CDE103','credit_hours': 1,'name':'Cloud Engineering'},
    ]
    for user in admins:
    ...
    for user in students:
        ...
        try:
            student.save()
            course = Course.query.filter_by(course_code='BEE1O1').first()
